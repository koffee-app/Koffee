...
// DISCLAIMER: Big country table made by https://github.com/launchdarkly/go-country-codes. All rights and props to them.
// 						 Original file changed only for having a map[string]CountryCode variable to make hash table lookups
...
var countries map[string]CountryCode
...
func Init() {
	countries = map[string]CountryCode{
		/**
